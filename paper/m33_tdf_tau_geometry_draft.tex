% Phase 6C — first readable manuscript draft (M33 TDF tau-geometry)
% Numerical values: outputs/tables/phase6a_key_results_table.csv (fit mask 0.4--23 kpc).
% Bibliography: TODO placeholders — verify before submission.
...
\author{M33 TDF $\tau$-Geometry Collaboration\\ \textit{Phase 6C first readable draft --- claim review required}}
\date{\today}
...
Phase~6A/6B/6C audits: \texttt{run\_phase6a\_publication\_audit.py}, \texttt{run\_phase6b\_manuscript\_audit.py}, \texttt{run\_phase6c\_manuscript\_draft\_audit.py}.

\bibliographystyle{plain}
\begin{thebibliography}{99}
\bibitem[Corbelli et al.(2014)]{Corbelli2014}
% TODO: verify journal volume, pages, and full author list before submission.
...
% TODO: verify MNRAS volume, pages, DOI.
L\'opez Fune, M.~C., Salucci, P., \& Corbelli, E.\ 2017, MNRAS, 474, 4010 --- \textit{placeholder; verify}.
\end{thebibliography}
